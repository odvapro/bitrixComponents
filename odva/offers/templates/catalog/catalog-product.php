<div class="catalog__rec-block clearfix">
	<div class="catalog__rec-left">
		...
		if ($product['SECTION'])
		{
			?><div class="catalog__rec-pretitle"><?=$product['SECTION']['NAME']?></div><?php
		}
		...
		<div class="catalog__rec-price clearfix">
			<div class="catalog__rec-buy">
				<span class="catalog__rec-money"><?=$offer['PRICE']['FORMAT_PRICE']?></span><div class="svg-rouble svg-rouble-dims catalog__rec-svg"></div>
			</div>
