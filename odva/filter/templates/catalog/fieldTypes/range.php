	...
	>
		<div class="filter__pricerange-input">
			<input
				name="minprice"
				id="minprice"
				data-filtervalue="<?=$arFields['VALUES']['current'][0]?>"
				data-filtermax="<?=$arFields['VALUES']['maximum'][0]?>"
				value=""
		...
		<div class="filter__pricerange-input filter__pricerange-input__right">
			<input
				name="maxprice"
				id="maxprice"
				data-filtervalue="<?=$arFields['VALUES']['current'][1]?>"
				data-filtermax="<?=$arFields['VALUES']['maximum'][1]?>"
				value=""
